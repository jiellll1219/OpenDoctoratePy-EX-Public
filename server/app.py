...
app.add_url_rule('/building/getRecentVisitors', methods=['POST'], view_func=building.buildingGetRecentVisitors)
app.add_url_rule('/building/getInfoShareVisitorsNum', methods=['POST'], view_func=building.buildingGetInfoShareVisitorsNum)
app.add_url_rule('/building/assignChar', methods=['POST'], view_func=building.buildingAssignChar)
app.add_url_rule('/building/changeDiySolution', methods=['POST'], view_func=building.buildingChangeDiySolution)
app.add_url_rule('/building/changeManufactureSolution', methods=['POST'], view_func=building.buildingChangeManufactureSolution)
app.add_url_rule('/building/settleManufacture', methods=['POST'], view_func=building.buildingSettleManufacture)
app.add_url_rule('/building/workshopSynthesis', methods=['POST'], view_func=building.buildingWorkshopSynthesis)
app.add_url_rule('/building/upgradeSpecialization', methods=['POST'], view_func=building.buildingUpgradeSpecialization)
app.add_url_rule('/building/completeUpgradeSpecialization', methods=['POST'], view_func=building.buildingCompleteUpgradeSpecialization)
app.add_url_rule('/building/deliveryOrder', methods=['POST'], view_func=building.buildingDeliveryOrder)
app.add_url_rule('/bulding/deliveryBatchOrder',methods=['POST'], view_func=building.buildingDeliveryBatchOrder)
app.add_url_rule('/building/cleanRoomSlot', methods=['POST'], view_func=building.buildingCleanRoomSlot)
app.add_url_rule('/building/getAssistReport', methods=['POST'], view_func=building.buildinggetAssistReport)
