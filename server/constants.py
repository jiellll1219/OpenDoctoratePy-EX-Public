...
# TABLE Urls
ACTIVITY_TABLE_PATH = BASE_URL + "/excel/activity_table.json"
CHARM_TABLE_PATH = BASE_URL + "/excel/charm_table.json"
SKIN_TABLE_PATH = BASE_URL + "/excel/skin_table.json"
CHARACTER_TABLE_PATH = BASE_URL + "/excel/character_table.json"
BATTLEEQUIP_TABLE_PATH = BASE_URL + "/excel/battle_equip_table.json"
EQUIP_TABLE_PATH = BASE_URL + "/excel/uniequip_table.json"
STORY_TABLE_PATH = BASE_URL + "/excel/story_table.json"
STAGE_TABLE_PATH = BASE_URL + "/excel/stage_table.json"
RL_TABLE_PATH = BASE_URL + "/excel/roguelike_topic_table.json"
DM_TABLE_PATH = BASE_URL + "/excel/display_meta_table.json"
RETRO_TABLE_PATH = BASE_URL + "/excel/retro_table.json"
HANDBOOK_INFO_TABLE_PATH = BASE_URL + "/excel/handbook_info_table.json"
TOWER_TABLE_PATH = BASE_URL + "/excel/climb_tower_table.json"
GACHA_TABLE_PATH = BASE_URL + "/excel/gacha_table.json"
